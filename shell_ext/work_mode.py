...
WEBSITES = ['twitter.com', 'reddit.com', 'youtube.com', 'news.ycombinator.com', 'facebook.com']
HOST_FILE = '/etc/hosts'
...
if __name__ == '__main__':
    ...
    env_setup.updateFileContentBetweenMarks(HOST_FILE, mark_begin, mark_end, content, False)
